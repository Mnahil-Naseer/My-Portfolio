...
const About = ({ darkMode }) => {
  ...
  return (
    <div>
      ...
      >
        <div className="relative ml-2 mt-6 md:ml-24 animate-slideinLeft flex flex-col justify-center items-center md:items-start md:w-1/2 text-center md:text-left p-8">
